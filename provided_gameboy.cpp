...
// once  you call this, then you can write a keydown and keyup function to
// handle key press

// if you use this, check for a return value of "3".  this is ctrl-c.  if you
// see a 3, call return from main to stop program
int getch() {
  int r;
  unsigned char c;
